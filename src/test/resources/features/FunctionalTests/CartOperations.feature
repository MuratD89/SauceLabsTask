...
Feature: Cart Operations 
  ...
  Scenario: Cart Operations Positive Test
    ...
    And HomePage: I add to cart/remove: "add to cart" the product with name: "Test.allTheThings() T-Shirt (Red)" on the home page
    And HomePage: I add to cart/remove: "remove" the product with name: "Test.allTheThings() T-Shirt (Red)" on the home page
